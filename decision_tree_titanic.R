...
### READING DATA ###
train <- read.csv("/Users/vivekkalyanarangan/Desktop/Decision Tree Project/input/train.csv")
test  <- read.csv("/Users/vivekkalyanarangan/Desktop/Decision Tree Project/input/test.csv")
test$Survived <- 0
